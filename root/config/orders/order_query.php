...
echo "<table class=\"table\">";
   echo "<thead>";
      echo "<tr>";
         ...
         echo "<a href=\"../../intern/sites/order_show.php\"?=><th scope=\"col\">".$lang_ordershow[$_SESSION['language']][1]."</th>";
         echo "<th scope=\"col\">".$lang_ordershow[$_SESSION['language']][2]."</th>";
         echo "<th scope=\"col\">".$lang_ordershow[$_SESSION['language']][3]."</th>";
         echo "<th scope=\"col\">".$lang_ordershow[$_SESSION['language']][4]."</th>";
         echo "<th scope=\"col\">".$lang_ordershow[$_SESSION['language']][5]."</th>";
